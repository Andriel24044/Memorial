...
def cria_candidato_senha(letras_possiveis): #foi atualizado para não depender do tamanho da senha
...
def funcao_objetivo_senha(candidato, senha_verdadeira): #sofreu modificações para não precisar do tamanho da senha
    ...
    if len(candidato) == len(senha_verdadeira): #se o tamanho da senha candidata for verdadeiro
